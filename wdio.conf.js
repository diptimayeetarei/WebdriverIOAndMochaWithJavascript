...
const conf = {
  reportPortalClientConfig: { // report portal settings
    ...
    launch: 'login_TEST_EXAMPLE', // we can change the launch name
    project: 'diptimayeetarei_personal',
    mode: 'DEFAULT',
    debug: false,
    description:
      '<p style="color:#428bca;border: 2px solid #428bca; border-bottom-width: thick; padding: 0px 10px 0px 10px; border-bottom-width: thick; width: fit-content; border-radius:50px;"><Strong>Automation test execution for YOUR PROJECT</Strong></p>',
    //   description: "Description about test launch",// You can add some text to describe about the run either you can add or we can add in run time
...
exports.config = {
  ...
  async afterTest(test, _context, { passed }) {
    console.log("entering aftertest")
    console.log("hhhhhhhhhhhhhhh", passed)
    if (passed) {
